...
public:
  ...
  void runOnOperation() override {
    ...
    llvm::SmallVector<StringRef> fusionFuncAttrs = {
        getByteIRCatFusionAttrName(),
        getByteIRReduceFusionAttrName(),
        getByteIRElementwiseFusionAttrName(),
        getByteIRMatmulEpilogueFusionAttrName(),
        getByteIRReductionFusionAttrName(),
        getByteIRTrivialFusionAttrName(),
        getByteIRHloAggressiveFusionAttrName()};

    for (auto &&name : fusionFuncAttrs) {
